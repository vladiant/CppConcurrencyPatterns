...
void demo_basic_usage() {
  ...
  LockfreeSizeAtomicSeqCstSpsc<int> queue(10);
...
void demo_queue_full() {
  ...
  LockfreeSizeAtomicSeqCstSpsc<int> queue(5);  // Small queue
...
void demo_producer_consumer() {
  ...
  LockfreeSizeAtomicSeqCstSpsc<int> queue(100);
...
void demo_performance() {
  ...
  LockfreeSizeAtomicSeqCstSpsc<int> queue(1024);
  std::atomic<bool> done{false};
