...
void demo_basic_usage() {
  ...
  LockfreeAtomicPushPopSeparateCacheLineSpsc<int> queue(10);
...
void demo_queue_full() {
  ...
  LockfreeAtomicPushPopSeparateCacheLineSpsc<int> queue(5);  // Small queue
...
void demo_producer_consumer() {
  ...
  LockfreeAtomicPushPopSeparateCacheLineSpsc<int> queue(100);
...
void demo_performance() {
  ...
  LockfreeAtomicPushPopSeparateCacheLineSpsc<int> queue(1024);
  std::atomic<bool> done{false};
