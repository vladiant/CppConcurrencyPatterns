...
void demo_basic_usage() {
  ...
  LockfreeAtomicPushPopPtrCachingSpsc<int> queue(10);
...
void demo_queue_full() {
  ...
  LockfreeAtomicPushPopPtrCachingSpsc<int> queue(5);  // Small queue
...
void demo_producer_consumer() {
  ...
  LockfreeAtomicPushPopPtrCachingSpsc<int> queue(100);
...
void demo_performance() {
  ...
  LockfreeAtomicPushPopPtrCachingSpsc<int> queue(1024);
  std::atomic<bool> done{false};
